                    ...
                    <table class="table table-bordered dataTable" width="100%" cellspacing="0">
                        ...
                        <?php foreach($clientes as $cliente): ?>
                            <tr>
                                ...
                                <td><?php echo ($cliente->cliente_tipo == 1 ? 'Pessoa fisica' : 'Pessoa juridica' ) ?></td>
                                <td class="text-center pr-2"><?php echo ($cliente->cliente_ativo == 1 ? '<span class="badge badge-primary btn-sm">Sim</span>' : '<span class="badge badge-warning btn-sm">Não</span>' ) ?></td>
                                <td class="text-right">
                                    <a href="<?php echo base_url('clientes/edit/'.$cliente->cliente_id) ?>" title="Editar" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i>&nbsp; Editar</a>
                                    <a href="javascript(void)" data-toggle="modal" data-target="#cliente-<?php echo $cliente->cliente_id; ?>" title="Excluir" class="btn btn-sm btn-danger"><i class="fas fa-trash-alt"></i>&nbsp; Excluir</a>
                                </td>
                            </tr>
